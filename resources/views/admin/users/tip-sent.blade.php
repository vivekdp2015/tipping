...
<div class="row">
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Tip Sent</h3>
            </div>
            <div class="box-body">
                <table id="tip-sent-table" class="table table-bordered">
                    <thead>
                        <tr>
...
<script type="text/javascript">
    var dTable = '';
	jQuery(function() {
	    dTable = jQuery('#tip-sent-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: {
                url: '{{ route('admin.users.tip_sent_data', $user->id) }}',
                type: "POST",
                data: function (d) {
